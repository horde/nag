  ...
  <td valign="top">
    <table width="100%" border="0" cellpadding="5" cellspacing="0">
      ...
      <tr<?php if ($i++ % 2) {
        ...
        <td width="5">&nbsp;</td>
        <td width="100%"><font size="2"><strong><?php   use function PHP81_BC\strftime; echo $this->due->strftime($this->dateFormat) ?>, <?php echo $this->due->format($this->timeFormat) ?></strong></font></td>
      </tr>
