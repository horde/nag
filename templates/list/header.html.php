<div class="header">
 ...
 <?php if (!empty($this->smartShare)): ?>
   <small><a href="<?php echo Horde::url('search.php')->add('smart_id', $this->smartShare->getName()); ?>"><?php echo $this->tag('img', ['src' => Horde_Themes::img('edit.png')]); ?></a></small>
 <?php endif; ?>
 <a id="quicksearchL" href="<?php echo Horde::url('search.php') ?>" title="<?php echo _("Search") ?>" onclick="$('quicksearchL').hide(); $('quicksearch').show(); $('quicksearchT').focus(); return false;"><?php /**
 * ARCHITECTURE VIOLATION: Using deprecated Horde::img()
 * @deprecated Use Horde_Themes_Image::tag() instead
 * @see Horde_Deprecated::img()
 */
echo Horde::img('search.png', _("Search")) ?></a>
